		...
		<div class="uk-grid">
			...
			<div class="uk-width-medium-9-10">
				...
				<table class="uk-table">
					<thead>
						<tr>
							...
							<th class="uk-width-1-10">
								<?php echo $this->app->html->_('grid.sort', 'PLG_ZLFRAMEWORK_CODE', 'code', @$this->lists['order_Dir'], @$this->lists['order']); ?>
							</th>
							<th class="uk-width-1-10">
								<?php echo JText::_('PLG_ZLFRAMEWORK_SYMBOL'); ?>
							</th>
							<th class="uk-width-1-10">
								<?php echo $this->app->html->_('grid.sort', 'PLG_ZOOCART_CONVERSION_RATE', 'conversion_rate', @$this->lists['order_Dir'], @$this->lists['order']); ?>
							</th>
							<th class="uk-width-4-10 uk-text-center">
								<?php echo JText::_('PLG_ZOOCART_DISPLAY_EXAMPLE'); ?>
							</th>
					...
					<tbody>
						...
						<tr data-row="<?php echo htmlentities(json_encode($data)); ?>">
							...
							<td class="uk-width-3-10 uk-text-center">
								<?php echo $this->app->zoocart->currency->format('123456.78', $row); ?>
								/
								<?php echo $this->app->zoocart->currency->format('-123456.78', $row); ?>
							</td>
				...
				<?php
					...
					$title   = JText::_('PLG_ZOOCART_CONFIG_NO_CURRENCIES_YET');
					$message = JText::_('PLG_ZOOCART_CONFIG_CURRENCIES_MANAGER_DESC');
